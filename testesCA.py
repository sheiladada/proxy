...
testesfuncoesCA.testeAdicionarConexao('10.0.0.1', 11111, '192.168.0.1', '192.168.0.2', 22222, 33333, respostaEsperadaCliente, respostaEsperadaRot)
...
testesfuncoesCA.testeAdicionarConexao('10.0.0.1', 11112, '192.168.0.1', '192.168.0.2', 22221, 33333, respostaEsperadaCliente, respostaEsperadaRot)

#adiciona conexão para a mesma porta cliente, deve dar exceção
respostaEsperadaCliente = {'10.0.0.1': {11112: ['192.168.0.1', '192.168.0.2', 22221, 33333], 11111: ['192.168.0.1', '192.168.0.2', 22222, 33333]}}
respostaEsperadaRot = {'192.168.0.2': [22222, 22221]}
testesfuncoesCA.testeAdicionarConexao('10.0.0.1', 11111, '192.168.0.1', '192.168.0.2', 22223, 33333, respostaEsperadaCliente, respostaEsperadaRot)

#adiciona conexão para a mesma porta roteador destino, deve dar exceção
respostaEsperadaCliente = {'10.0.0.1': {11112: ['192.168.0.1', '192.168.0.2', 22221, 33333], 11111: ['192.168.0.1', '192.168.0.2', 22222, 33333]}}
respostaEsperadaRot = {'192.168.0.2': [22222, 22221]}
testesfuncoesCA.testeAdicionarConexao('10.0.0.1', 11113, '192.168.0.1', '192.168.0.2', 22221, 33333, respostaEsperadaCliente, respostaEsperadaRot)
